...
double krr_t = x18*((1.0/4.0)*grr*x10*(grr_z - x9) - grr_rr*x8 + (1.0/2.0)*grz_r*x6 + gzz*x15*(-grr_z*lapse_z - grr_zz*lapse - gzz_rr*lapse + kzz*x2 - 4*lapse*x14 + lapse_z*x9 + x1*x13) + x12*(krr*x0 + krr_z*shiftz - 6*lapse*s_r - lapse_rr - x1*x11 + x1*zr_r));
