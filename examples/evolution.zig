...
pub const BrillEvolution = struct {
    ...
    pub const Evolution = struct {
        ...
        pub fn derivative(self: Evolution, deriv: System(Tag), dynamic: SystemConst(Tag), time: f64) Error!void {
            ...
            @memset(lapse, 0.0);
            worker.projectAll(lapse_rhs, rhs);
            ...
            worker.fillGhostNodesAll(lapse_boundary, lapse);
            ...
            // ShiftR
            @memset(shiftr, 0.0);
            worker.projectAll(shiftr_rhs, rhs);
            ...
            worker.fillGhostNodesAll(shiftr_boundary, shiftr);

            // ShiftZ
            @memset(shiftz, 0.0);
            worker.projectAll(shiftz_rhs, rhs);
            ...
            worker.fillGhostNodesAll(shiftz_boundary, shiftz);
