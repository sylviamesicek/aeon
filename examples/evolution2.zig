...
pub fn BrillEvolution(comptime M: usize) type {
    ...
    return struct {
        ...
        pub const Evolution = struct {
            ...
            pub fn derivative(self: Evolution, deriv: System(Tag), dynamic: System(Tag), time: f64) void {
                ...
                for (0..mesh.levels.len) |rev_level_id| {
                    ...
                    dofs.fillLevelBoundary(mesh, level_id, psi_boundary, psi);
                    ...
                    dofs.fillLevelBoundary(mesh, level_id, w_boundary, w);

                    dofs.restrictLevel(mesh, level_id, psi);
                    dofs.restrictLevel(mesh, level_id, seed);
                    dofs.restrictLevel(mesh, level_id, u);
                    dofs.restrictLevel(mesh, level_id, y);
                    dofs.restrictLevel(mesh, level_id, w);
                }
                ...
                dofs.project(mesh, psi_evolve, sol);
                dofs.transfer(mesh, psi_boundary, deriv.field(.psi), sol);
                ...
                dofs.project(mesh, w_evolve, sol);
                dofs.transfer(mesh, w_boundary, deriv.field(.w), sol);
            }
        };
        ...
        fn run(allocator: Allocator) !void {
            ...
            dofs.transfer(&mesh, eta_boundary, eta, sol);
...

            {
                ...
                dofs.project(&mesh, hamiltonain, sol);
            ...
            for (0..steps) |step| {
                ...
                dofs.project(&mesh, hamiltonian, sol);
                dofs.transfer(&mesh, constraint_boundary, constraint, sol);
