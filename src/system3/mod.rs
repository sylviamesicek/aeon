...
pub trait System {
    ...
    fn label_to_index(&self, label: Self::Label) -> usize;
...
impl System for Empty {
    ...
    fn label_to_index(&self, _: Self::Label) -> usize {
        unreachable!()
    }
}
...
impl<A: System, B: System> System for (A, B) {
    ...
    fn label_to_index(&self, label: Self::Label) -> usize {
        match label {
            Pair::First(a) => self.0.label_to_index(a),
            Pair::Second(b) => self.1.label_to_index(b),
        }
    }
